...
const DashboardHeader = ({ onNewLead }: DashboardHeaderProps) => {
  ...
  return (
    <header className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center justify-between mb-4 sm:mb-8">
      ...
      <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
        ...
        <Button
          onClick={onNewLead}
          className="bg-gradient-primary hover:opacity-90 text-primary-foreground gap-2 shadow-glow h-10 shrink-0"
        >
          <Plus className="w-4 h-4" />
          <span className="hidden sm:inline">Novo Lead</span>
        </Button>

        <Button variant="ghost" size="icon" onClick={signOut} title="Sair" className="h-10 w-10 shrink-0">
